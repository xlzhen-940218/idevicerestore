...
/* ./.libs/lt-idevicerestore.c - temporary wrapper executable for .libs/idevicerestore.exe
   Generated by libtool (GNU libtool) 2.4.7

   The idevicerestore program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "C:\\msys64\\mingw32\\lib;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "C:\\msys64\\mingw32\\lib;C:\\msys64\\mingw32\\bin;";
const char * TARGET_PROGRAM_NAME = "idevicerestore.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# idevicerestore - temporary wrapper script for .libs/idevicerestore.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.7\n", f);
  fputs ("#\n", f);
  fputs ("# The idevicerestore program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' C:/msys64/mingw32/lib/libirecovery-1.0.la C:/msys64/mingw32", f);
  fputs ("/lib/libimobiledevice-1.0.la /mingw32/lib/libusbmuxd-2.0.la C:/msys64/mingw32/l", f);
  fputs ("ib/libusbmuxd-2.0.la /mingw32/lib/libimobiledevice-glue-1.0.la C:/msys64/mingw3", f);
  fputs ("2/lib/libimobiledevice-glue-1.0.la C:/msys64/mingw32/lib/libtatsu.la /mingw32/l", f);
  fputs ("ib/libplist-2.0.la C:/msys64/mingw32/lib/libplist-2.0.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"idevicerestore.exe:idevicerestore:$LINENO: libtool wrapper (GNU libto", f);
  fputs ("ol) 2.4.7\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"idevicerestore.exe:idevicerestore:$LINENO: newargv[$lt_dump_args_N]:", f);
  fputs (" $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"idevicerestore.exe:idevicerestore:$LINENO: newargv[0]: $progdir/", f);
  fputs ("$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='idevicerestore.exe'\n", f);
  ...
  fputs ("    PATH=/mingw32/lib:/mingw32/bin:$PATH\n", f);
  fputs ("\n", f);
